...
function onGoogleChartReady(){
    ...
    var columns =[
        {type:'string', id:'id', label:'trianing id'},
        {type:'string', id:'ws_seq', label:'平台編號'},
        {type:'string', id:'model_id', label:'模型編號'},
        {type:'string', id:'selector_name', label:'選品算法'},
        {type:'string', id:'selector_ver', label:'選品算法版本'},
        {type:'string', id:'updated_at', label:'updated at'},
        {type:'string', id:'created_at', label:'created at'},
        {type:'string', id:'comment', label:'註解'},
    ];
